...
import AdminAnalysisDetail from './components/AdminAnalysisDetail';
          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex space-x-2">
                ...
                <Link to="/privacy" className="relative px-4 py-2 text-slate-700 hover:text-green-600 font-medium transition-all duration-300 rounded-xl group overflow-hidden">
                  ...
                  <span className="relative">プライバシー</span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <Routes>
            ...
            <Route path="/privacy" element={
              <div className="min-h-screen bg-gray-50 py-8">
                <div className="container mx-auto px-4">
                  <h1 className="text-3xl font-bold text-gray-900 mb-8">プライバシー設定</h1>
                  <PrivacySettings />
                </div>
              </div>
            } />
        ...
        <footer className="bg-slate-900/95 backdrop-blur-xl border-t border-slate-700/50 mt-auto">
          <div className="container mx-auto px-4 py-12">
            <div className="text-center">
              ...
              <div className="w-16 h-px bg-gradient-to-r from-transparent via-cyan-500 to-transparent mx-auto mb-4"></div>
              <div className="text-xs text-slate-500">
                <Link to="/admin/login" className="hover:text-slate-400 transition-colors duration-200">
                  管理者ログイン
                </Link>
              </div>
            </div>
